package com.faltdor.recipe.boostrap;
...
import com.faltdor.recipe.services.impl.RoleServiceImpl;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	@Autowired
	public DevBootstrap(IRecipeRepository recipeRepository, 
...
//        assignUsersToAdminRole();
	...
	private List<Recipe> getRecipes() {
		...
		Optional<UnitOfMeasure> uomEachOptinal = unitOfMeasureRepository.findByDescription("Each");
		if (!uomEachOptinal.isPresent()) {
		...
		// get optionals
		UnitOfMeasure eachUom = uomEachOptinal.get();
